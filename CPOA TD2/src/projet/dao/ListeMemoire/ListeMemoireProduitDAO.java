...
public class ListeMemoireProduitDAO implements ProduitDAO {
	...
	private ListeMemoireProduitDAO() {
		...
		this.donnees.add(new Produit(2, "Sonic te kiffe", "InspirÈ par la saga SÈga (c'est plus fort que toi !), un pull 100% gamer qui te permettra de faire baver d'envie tes petits camarades de jeu.", 41.5, "pull1.png", 1));
	...
	public Produit getById(int id) {
		// Ne fonctionne que si l'objet m√©tier est bien fait...
		int idx = this.donnees.indexOf(new Produit(2, "Sonic te kiffe", "InspirÈ par la saga SÈga (c'est plus fort que toi !), un pull 100% gamer qui te permettra de faire baver d'envie tes petits camarades de jeu.", 41.5, "pull1.png", 1));
		if (idx == -1) {
